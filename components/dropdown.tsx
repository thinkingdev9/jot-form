const Dropdown = () => {
  return (
    <select className="appearance-none border-none outline-none bg-transparent text-green-300 cursor-pointer">
      <option className="hidden text-center" value="o">ｏ</option>
